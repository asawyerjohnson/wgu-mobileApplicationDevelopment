 ...
 * in a {@link AssessmentListActivity}.
 */
public class AssessmentDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(AssessmentDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(AssessmentDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, AssessmentListActivity.class));
            return true;
        }
